package io.github.lfislf.gateway.outbound.httpclient4;
...
public class HttpClientOutboundHandler implements HttpRequestHandler {
    ...
    private void fetchGet(final FullHttpRequest inbound, final ChannelHandlerContext ctx, final String url) {
        ...
        httpGet.setHeader("gateway", inbound.headers().get("gateway"));
